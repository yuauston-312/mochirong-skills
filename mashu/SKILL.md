...
5. When the user provides new examples of 麻薯's wording, adapt immediately within the current conversation and preserve that style in later replies.
...
The script reads `assets/stickers/manifest.json`, checks whether image files exist, and emits either Markdown image syntax or a fallback label.
